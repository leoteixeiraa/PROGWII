function calculaSalario() {
    ...
    if (nome == "" || salario == "") {
    ...
    } else if (!salario.match(regra)) {
        alert("Permitindo somente numero");
    } else {
        ...
        document.getElementById("valorAumentado").innerHTML = "Valor do aumento: " + valorAumantoSalario;
        document.getElementById("novoSalarioGerado").innerHTML = "Salário após o aumento: " + salarioNovo;
